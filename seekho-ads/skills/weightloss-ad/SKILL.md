---
name: weightloss-ad
description: Write Seekho-style Hinglish weight-loss ad creatives for Tier 2-3 India (female-skewed, 18-45). Use whenever the user wants to draft, write, generate, brainstorm, or create a short-form ad script, creative, copy, hook, or video ad for Seekho's weight-loss vertical — even if they only say "ad", "script", "creative", "hook", "30-second ad", "Reels ad", "Meta ad", "weight loss video", or mention contexts like "bahu/saas", "kapde tight", "blouse fitting", "post-pregnancy", "PCOD", "thyroid", "vajan", "motapa". Also trigger for ad variants, A/B hook variants, hook brainstorming, or polishing/editing a weight-loss ad. Enforces a 4-stage flow (ask length-in-words + clarifying Qs → creative-decisions table → confirm → deliver spoken script → feedback) with ASCI/Meta compliance and Tier-2/3 vocabulary guardrails. Do not invoke for other verticals (non-weight-loss) or English-only ad copy.
---
